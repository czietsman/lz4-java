...
public class LZ4BlockStreamingTest extends AbstractLZ4Test {
  ...
  public void testRoundTrip(byte[] data) throws IOException {
    ...
    final LZ4Compressor compressor = randomBoolean()
        ? LZ4Factory.INSTANCE.fastCompressor()
        : LZ4Factory.INSTANCE.highCompressor();
    ...
    final LZ4FastDecompressor decompressor = LZ4Factory.INSTANCE.fastDecompressor();
  ...
  public void testDoubleClose() throws IOException {
    ...
    LZ4BlockOutputStream out = new LZ4BlockOutputStream(bytes, 1 << 16, LZ4Factory.INSTANCE.fastCompressor());
    ...
    LZ4BlockInputStream in = new LZ4BlockInputStream(new ByteArrayInputStream(bytes.toByteArray()), LZ4Factory.INSTANCE.fastDecompressor());
